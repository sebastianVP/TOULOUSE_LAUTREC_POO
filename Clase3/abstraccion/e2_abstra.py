#https://github.com/dimas-avila/curso-python/blob/main/15-POO-abstraccion.py

'''
clases ABSTRACTAS:
* no las vamos a instanciar nunca directamente
* contiene por lo menos un metodo abstracto
* lo vamos a usar de base para clases mas especificas
'''
